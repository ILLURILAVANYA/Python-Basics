...
Original file is located at
    https://colab.research.google.com/drive/1jncDM-8ouCiKhD7mm3cMQZe08wbY8tk5
"""
...
import numpy as np
mask = np.array(PIL.Image.open('/content/12.jpg'))

mask.shape

wc = WordCloud(background_color='white', mode="RGBA",mask=mask)
wc.generate(text)
